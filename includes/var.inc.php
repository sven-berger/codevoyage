...
$footer = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/python/templates/footer.html");
...
$wissensportal_sidebarRight = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/layout/sidebar/wissensportal.sidebarRight.php");

$acp_sidebarLeft = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/layout/sidebar/acp.sidebarLeft.php");
$acp_sidebarRight = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/layout/sidebar/acp.sidebarRight.php");
